                  ...
                  <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                    ...
                    <CardContent>
                      <p className="text-gray-700 leading-relaxed">
                        Tôi là một chuyên gia tư vấn với nhiều năm kinh nghiệm
                        trong lĩnh vực {consultant.consultant.specialization}. Tôi
                        cam kết mang đến cho bạn những lời khuyên chuyên nghiệp và
                        giải pháp tối ưu nhất cho vấn đề của bạn. Với phương pháp
                        tiếp cận nhân văn và khoa học, tôi sẵn sàng đồng hành cùng
                        bạn trên hành trình tìm kiếm giải pháp.
                      </p>
                    </CardContent>
                  </Card>
                        ...
                        <div className="flex justify-center space-x-1">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              ...
                              className={`w-5 h-5 ${
                                i <
                                Math.floor(consultant.consultant.average_rating)
