...
export function columns({ onDeleted }: { onDeleted: (id: string) => void }): ColumnDef<AppointmentListType>[] {
  return [
    {
    ...
    },
    {
      id: "actions",
      header: "Thao tác",
      cell: ({ row }) => <CellActions appointment={row.original} onDeleted={onDeleted} />,
    },
  ];
}
