...
import { AppointmentDetailResponse } from "@/types/appointment/appointmentDetail";
...
export default function ResultTesting({ appointmentId }: ResultTestingProps) {
  ...
  const [fullResultOpen, setFullResultOpen] = useState(false); // State cho dialog kết quả đầy đủ
  ...
  // Hàm kiểm tra và rút gọn kết quả nếu quá dài
                  ...
                  <CardContent className="animate-modal-content">
                    <div className="grid grid-cols-1 gap-2">
                      ...
                      <div>
                        ...
                        >
                          {data.appointment.type === "Testing" ? "Xét nghiệm" : "Tư vấn"}
                        </Badge>
                      </div>
                      <div>
                        <p className="text-muted-foreground text-sm mb-1">
                          ...
                          <div className="w-5/6">
                            ...
                            <p className="font-medium line-clamp-1">
                              ...
                              "Pending" ? (
                                ...
                                <Dialog open={fullResultOpen} onOpenChange={setFullResultOpen}>
                                  <DialogTrigger asChild>
                                    <span
                                      className="break-words overflow-hidden cursor-pointer hover:underline"
                                      onClick={() => setFullResultOpen(true)}
                                    >
                                      {truncateResult(data.appointment.test_result.result_data)}
                                    </span>
                                  </DialogTrigger>
