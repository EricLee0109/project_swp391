        ...
        <div className="grid grid-cols-12 gap-5">
          ...
          <div className="col-span-12 sm:col-span-3">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/our-team">Đội ngũ của chúng tôi</Link>
              </li>
              <li>
                <Link href="/flagship-store">Phòng khám hàng đầu</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="col-span-12 sm:col-span-3">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/faq/contact">Liên hệ</Link>
              </li>
              <li>
                <Link href="/faq/services-and-maintenance">
                  Dịch vụ & Bảo trì
                </Link>
              </li>
              <li>
                <Link href="/faq/shipping-policies">Chính sách vận chuyển</Link>
              </li>
              <li>
                <Link href="/faq/terms-of-service">Điều khoản dịch vụ</Link>
              </li>
              <li>
                <Link href="/faq/return-policies">Chính sách trả hàng</Link>
              </li>
              <li>
                <Link href="/faq/privacy-policies">Chính sách bảo mật</Link>
              </li>
            </ul>
          </div>
